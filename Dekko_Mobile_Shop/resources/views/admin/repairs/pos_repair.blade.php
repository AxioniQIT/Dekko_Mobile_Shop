...
<div class="container mt-4">
    ...
    <div class="text-center mb-4">
        <h1 class="fw-bold text-dark"><i class="fas fa-tools me-2"></i>  POS Repair Dashboard</h1>
        <p class="text-muted">Manage and track repair tasks effectively</p>
    </div>
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
        <div class="d-flex align-items-center w-100 w-sm-auto">
            <input type="text" class="form-control mb-2 mb-sm-0 search-bar" id="search" placeholder="Search by Repair ID or Customer">
            <input type="text" class="form-control mb-2 mb-sm-0 search-bar ms-2" id="category" placeholder="Device Type">
    ...
    <div class="d-flex flex-wrap gap-4 justify-content-between">
        ...
        <div class="flex-column shadow-lg p-3 mb-4 bg-light rounded" style="flex: 1 1 100%; max-width: 48%;">
            <div class="bg-primary text-white text-center p-3 rounded-top">
                <h5 class="mb-0"><i class="fas fa-list me-2"></i> Repairs List</h5>
            </div>
            <div class="p-4">
...
<br><br>
                    <div class="d-flex justify-content-between">
                        <p><strong>Total:</strong> 1700.00</p>
                        <p><strong>Discount:</strong> 200.00</p>
                        <p><strong>Final Total:</strong> 1500.00</p>
                    </div>
<br>
