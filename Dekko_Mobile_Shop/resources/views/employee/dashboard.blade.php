...
<div class="container mt-4">
    ...
    <div class="text-center mb-4">
        <h1 class="fw-bold"><i class="fas fa-tachometer-alt me-2"></i> Employee Dashboard</h1>
        <p class="text-muted">Welcome to your Employee panel, manage all aspects of your system.</p>
    </div>
