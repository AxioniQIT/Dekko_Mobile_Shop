...
<body>
    <div class="d-flex">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <a href="{{ route('employee.dashboard') }}" class="d-flex align-items-center">
            ...
            <div class="repairs-menu">
                ...
                <div class="collapse repairs-submenu" id="repairsMenu">
                    <a href="{{ route('employee.repairs.addrepair') }}" class="submenu-link d-flex align-items-center">
                        <i class="fas fa-plus-circle me-2 text-success"></i> Add Repairs
                    </a>

                    <a href="{{ route('employee.repairs.management') }}" class="submenu-link d-flex align-items-center">
                        <i class="fas fa-cogs me-2 text-primary"></i> Repairs Management
                    </a>

                    <a href="{{ route('employee.repairs.repairUpdates') }}" class="submenu-link d-flex align-items-center">
                        <i class="fas fa-sync-alt me-2 text-warning"></i> Repairs Updates
                    </a>

                    <a href="{{ route('employee.repairs', ['status' => 'in-progress']) }}" class="submenu-link d-flex align-items-center">
                        <i class="fas fa-spinner me-2 text-info"></i> In Progress
                    </a>
                    <a href="{{ route('employee.repairs', ['status' => 'pending']) }}" class="submenu-link d-flex align-items-center">
                        <i class="fas fa-hourglass-half me-2 text-warning"></i> Pending
                    </a>
                    <a href="{{ route('employee.repairs', ['status' => 'completed']) }}" class="submenu-link d-flex align-items-center">
                        <i class="fas fa-check-circle me-2 text-success"></i> Completed
                    </a>
                    <a href="{{ route('employee.repairs', ['status' => 'cancelled']) }}" class="submenu-link d-flex align-items-center">
                        <i class="fas fa-times-circle me-2 text-danger"></i> Cancelled
                    </a>
                </div>
            </div>

            <a href="{{ route('employee.orderhistory') }}" class="d-flex align-items-center">
